...
import { ProductSystemRequirements } from "@/features/Product/ui/SystemRequirements/index";
...
export default async function SystemRequirementsPage({
  ...
  const items: {
    name: string;
    value: string;
  }[] = product.requirements.map((requirement: any) => ({
    name: requirement.type[`label_${lang}`],
    value: requirement[`text_${lang}`]
  }));
    ...
    <MainContainer>
      ...
      <div className="cheat-page mt-[18px]">
        ...
        <div className="cheat-page__container mt-[18px] flex items-start gap-5 max-md:flex-col">
          <ProductNavigation
            currentPath="system-requirements"
          />
